...
public class FilterToolTest {
    ...
    public void applyMovingAverage(){
        ...
        assertTrue(newDs.toString().equals("disk,mem,cpu,powerWatts\n" +
                "4.0,6.0,4.0,46.0\n" +
                "8.5,9.5,5.5,73.0\n" +
                "7.6,8.2,9.0,84.8\n" +
                "13.8,12.0,10.8,117.6\n" +
                "16.25,13.5,12.5,135.5\n" +
                "19.666666666666668,15.0,14.666666666666666,157.66666666666666\n"));
    }
